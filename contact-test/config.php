...
$recipient = "carls-cloud@carls-cloud.com";  // Please insert your email address (between the quotation marks)

$yourname = "Carl";  // Please insert your name here (between the quotation marks) It will appear as the sender in the thank-you mail.
...
$smtp['host'] = 'smtp.carls-cloud.com'; // SMTP server host (e.g. smtp.gmail.com)
   
$smtp['user'] = 'carls-cloud'; // User name to authenticate yourself on the SMTP server (could be the aforementioned email address!)

$smtp['password'] = 'Y#w6ejut-aarSB@Q'; // Password to authenticate yourself on the SMTP server.
...
$cfg['DOWNLOAD_URL'] = 'https://www.carls-cloud.com/contact-test';	// Path to the form (without / at the end)
