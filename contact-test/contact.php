...
<hr style="height:0.10rem; border:none; color:#DADADA; background-color:#DADADA; margin-top:40px; margin-bottom:35px;" />
			...
			<div class="row" id="send">
				...
				<div style="text-align:center;">
						<!-- Do NOT remove this copyright notice! --><br /><br />
						<a href="https://www.kontaktformular.com/en" title="kontaktformular.com" style="text-decoration: none;color:#000000;font-size:13px;" target="_blank">&copy; by Carls-Cloud.com - All rights reserved.</a>
					</div>
